...
//	mainLayout->setContentsMargins(5,5,5,5);
    ...
    m_statusLabel->setStyleSheet("font-weight: color: #444;");
...
void ViewSequencerunner::onStopClicked() {m_runner->stopSequence();}
...
void ViewSequencerunner::handleSequenceStarted()
{
    ...
    m_intervalLabel->setText("run...");
    m_intervalLabel->setStyleSheet("color: #4CAF50; font-weight: bold;");
...
void ViewSequencerunner::updateFromRunner()
{
    ...
    m_intervalSpin->setValue(60000);
    m_intervalLabel->setText("Interval: 60.0s");
}
...
void ViewSequencerunner::handleScheduleRestart(int ms) {
    ...
    m_intervalLabel->setText(QString("Next run: %1").arg(timeStr));
    if (!m_countdownTimer->isActive()) {m_countdownTimer->start(100); }}
