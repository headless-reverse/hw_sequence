...
private:
	...
	QDockWidget *m_dockProcessInjector = nullptr;
	ProcessInjector *m_processInjector = nullptr;
	QAction *m_viewProcessInjectorAct = nullptr;
	Core      *m_core = nullptr;
    CoreView  *m_dockCore = nullptr;
    QAction   *m_viewCoreAct = nullptr;
};
#endif // MAINWINDOW_H
