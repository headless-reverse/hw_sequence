...
public:
	...
	void setHardwareLogic(HardwareGrabbed* hw) { m_hwLogic = hw; }
...
signals:
    ...
    void runFullSequenceRequested(const QString &mode);
...
private slots:
	...
	void handleRemoteHardwareEvent(uint16_t axis, uint32_t value);
...
private:
	...
	QCheckBox				*m_useIoctlCheckbox = nullptr;
    QByteArray				m_rawBuffer;
    QImage					m_rawImage;
	bool					m_useRaw = true;
	bool					m_defaultToIoctl = true;
	...
	QString					m_recordMode = "shell";
    int						m_deviceWidth = 0;
    int						m_deviceHeight = 0;
	int						m_lastMonitoringStatus = -1;
	QPushButton				*m_recordButton;
	HardwareGrabbed			*m_hwLogic = nullptr;
